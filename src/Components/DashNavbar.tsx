...
type ExtraMenuOptions = {
  admin: boolean;
};

type MenuOptions = IMenuOption & ExtraMenuOptions;
...
export default function DashNavbar() {
  const { logout, currentUser, loading, userInfo } = useAuth();
  ...
  const filteredMenuOptions = userInfo.isAdmin
    ? menuOptions
    : menuOptions.filter((option) => !option.admin);
      ...
      <img
        ...
        src={
          !currentUser.photoURL
            ? `https://robohash.org/${currentUser.email}`
            : currentUser.photoURL
        }
        alt=""
      />
